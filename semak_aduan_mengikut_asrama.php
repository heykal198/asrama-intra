...
$query_Recordset1 = sprintf("SELECT * FROM aduan WHERE penempatan = '%s'", $colname_Recordset1);
...
<div id="tabs">
    ...
    <div id="tabs-1">
	<center>
      <p><a href="semak_aduan.php" style="color:#FFFFFF" type="button" class="btn btn-info">Kembali</a>     </p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
