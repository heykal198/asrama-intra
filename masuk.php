...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO asrama (asrama) VALUES (%s)",
                       GetSQLValueString($_POST['asrama'], "text"));
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      <td nowrap align="right">Asrama:</td>
      <td><input type="text" name="asrama" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
