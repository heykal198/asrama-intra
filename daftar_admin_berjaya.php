...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Daftar Admin Berjaya</a></li>
      </ul>

    <p>&nbsp;</p>
    <p><span class="style5">Daftar Admin Berjaya .....</span> <a href="<?php echo $logoutAction ?>" type="button" class="btn btn-danger">Log Out ?</a> <a href="home.php" type="button" class="btn btn-danger">Halaman Utama</a></p>
    <p>&nbsp;</p>
    <div id="tabs-1"><center><div id="div"></div>
	</center>
    </div> 
