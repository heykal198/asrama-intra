...
$Recordset1 = mysql_query($query_limit_Recordset1, $asrama) or die(mysql_error());
...
<div id="tabs">
    ...
    <p>&nbsp;</p>
    <p><a href="asrama.php" style="color:#FFFFFF" type="button" class="btn btn-danger">Kembali</a> <a href="carian_pelajar_mengikut_ic.php" style="color:#FFFFFF" type="button" class="btn btn-danger">Carian pelatih Mengikut I/C</a></p> 
    <div id="tabs-1">
	<center>
      <form action="papar_data.php" method="post" name="form1" class="btn-primary">
        <table width="328">
          <tr>
            <td width="274">Masukan  Nama pelajar: </td>
          </tr>
        </table>
        <label>
        <?php do { ?>
          <input name="nama" type="text" id="nama" value="<?php echo $row_Recordset1['nama']; ?>" size="35" placeholder="Nama pelatih">
          <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
        <br>
        <input name="Cari" type="submit" class="btn-info" id="Cari" value="Cari">
        </label>
        <label></label>
            </form>
		  </center>
