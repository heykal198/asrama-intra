...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Carian Kemaskini</a></li>
      </ul>

    <p>&nbsp;</p>
    <div id="tabs-1">
	<center>
      <form action="kemaskini_data.php?ic=<?php echo $row_Recordset1['ic']; ?>" method="post" name="form1" class="btn-primary">
        <table width="328">
          <tr>
        ...
        <label>
        <input name="ic" type="text" id="ic" size="35" placeholder="No Ic">
		<br>
