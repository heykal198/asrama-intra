...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE daftar SET nama=%s, pass=%s, hint=%s WHERE ic=%s",
...
<h6 id="h-menu-products" class="selected"><a href="aduan.php"></a></h6>
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Daftar Pelatih </a></li>
    </ul>
	  ...
	  <div id="div">
		    ...
		    <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
		      <table width="100%" border="0" class="art-article">
                ...
                <tr class="even">
                  <td><input style="border:none" name="nama" type="text" id="nama" value="<?php echo $row_Recordset1['nama']; ?>" size="58" /></td>
                </tr>
                <tr class="even">
                  <td>No. I/C  : </td>
                </tr>
                <tr class="even">
                  <td><input style="border:none" name="ic" type="text" id="ic" value="<?php echo $row_Recordset1['ic']; ?>" size="58" /></td>
                </tr>
                <tr class="even">
                  <td>Password :</td>
                </tr>
                <tr class="even">
                  <td><input name="pass" type="text" id="pass" value="<?php echo $row_Recordset1['pass']; ?>" size="58" /></td>
                </tr>
                <tr class="even">
                  <td>Soalan rahsia  &quot;kegunaan Forgot Password&quot; . </td>
                </tr>
                <tr class="even">
                  <td><label>
                    <input name="hint" type="text" id="hint" value="<?php echo $row_Recordset1['hint']; ?>" size="58">
                  </label></td>
                </tr>
                <tr class="even">
                  <td><input name="Kemaskini2" type="submit" class="btn-success" id="Kemaskini" value="Kemaskini"></td>
                </tr>
              </table>
