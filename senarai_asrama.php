...
<div id="tabs">
    ...
    <ul>
      <li><a href="#tabs-1">Senarai Asrama </a></li>
      </ul>
	  <p>      
	  <p><a href="asrama.php" style="color:#FFFFFF" type="button" class="btn btn-primary">Kembali</a>      
	    <a href="tambah_asrama.php" style="color:#FFFFFF" type="button" class="btn btn-info">Tambah Asrama</a>
	  <p><br>
        ...
        <?php do { ?>
          <tr>
            <td><a href="#"><?php echo $row_Recordset1['penempatan']; ?>  <span class="badge">12</span></a><br>
              </a></td>
            <td><div align="center"><a href="papar_asrama.php?penempatan=<?php echo $row_Recordset1['penempatan']; ?>" style="color:#FFFFFF" class="btn btn-primary">LIHAT</a>       |       <a href="padam_asrama.php?id=<?php echo $row_Recordset1['id']; ?>"onclick="return confirm('Are you sure want to delete?');" style="color:#FFFFFF" class="btn btn-danger">PADAM </a> <div></td>
            </tr>
