...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bayar (id, nama, ic, penempatan, bayaran, tarikh_bayar) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id'], "int"),
                       GetSQLValueString($_POST['nama'], "text"),
                       GetSQLValueString($_POST['ic'], "text"),
                       GetSQLValueString($_POST['penempatan'], "text"),
                       GetSQLValueString($_POST['bayaran'], "text"),
                       GetSQLValueString($_POST['tarikh_bayar'], "text"));

  mysql_select_db($database_asrama, $asrama);
  $Result1 = mysql_query($insertSQL, $asrama) or die(mysql_error());

  $insertGoTo = "kemaskini_bayaran.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['ic'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['ic'] : addslashes($_GET['ic']);
}
mysql_select_db($database_asrama, $asrama);
$query_Recordset1 = sprintf("SELECT * FROM bayar WHERE ic = '%s'", $colname_Recordset1);
...
if (isset($_GET['ic'])) {
  $colname_Recordset2 = (get_magic_quotes_gpc()) ? $_GET['ic'] : addslashes($_GET['ic']);
}
mysql_select_db($database_asrama, $asrama);
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Kemaskini Bayaran</a></li>
    </ul>
	...
	<center>
      ...
      <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
        <table width="944" height="124" border="1">
          <tr>
            <th height="36" colspan="2"><div align="center">NAMA</div></th>
            <th width="120"><div align="center">IC</div></th>
            <th width="239"><div align="center">ASRAMA</div></th>
            <th width="208"><div align="center">BAYARAN</div></th>
            <th><div align="center">TARIKH</div></th>
          </tr>
          <tr>
            <td width="18" height="49"><div align="center">
              <input name="id" type="hidden" id="id">
            </div></td>
            <td width="128"><div align="center">
              <input name="nama" type="text" id="nama" value="<?php echo $row_Recordset2['nama']; ?>" size="15" readonly/>
            </div></td>
            <td><div align="center">
              <input name="ic" type="text" id="ic" value="<?php echo $row_Recordset2['ic']; ?>" size="15" readonly/>
            </div></td>
            <td><div align="left">
              <input name="penempatan" type="text" id="penempatan" value="<?php echo $row_Recordset2['penempatan']; ?>" size="32" readonly/>
            </div></td>
            <td><div align="center">
              <input oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required name="bayaran" type="text" id="bayaran" value="<?php echo $row_Recordset1['bayaran']; ?>" size="10" />
            </div></td>
            <td width="192"><div align="center">
              <input oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required name="tarikh_bayar" type="date" id="tarikh_bayar" value="<?php echo $row_Recordset1['tarikh_bayar']; ?>">
            </div></td>
          </tr>
          <tr>
            <td height="11" colspan="6"><div align="right">
              <p>&nbsp;                </p>
              <p>
                <label>
      ...
      <form name="form2" method="post" action="">
        <table width="950" height="119" border="1">
          <tr>
            <th height="36">&nbsp;</th>
            <th height="36"><div align="center">NAMA</div></th>
            <th width="98"><div align="center">IC</div></th>
            <th width="171"><div align="center">ASRAMA</div></th>
            <th width="129"><div align="center">BAYARAN</div></th>
            <th><div align="center">TARIKH</div></th>
            <th><div align="center">CETAK</div></th>
          </tr>
          <?php do { ?>
            <tr>
                <td width="23" height="75"><input name="id2" type="hidden" id="id2" value="<?php echo $row_Recordset1['id']; ?>"></td>
                <td width="209"><div align="center"><?php echo $row_Recordset1['nama']; ?></div></td>
              <td><div align="center"><?php echo $row_Recordset1['ic']; ?></div></td>
              <td><div align="center"><?php echo $row_Recordset1['penempatan']; ?></div></td>
              <td><div align="center"><?php echo $row_Recordset1['bayaran']; ?></div></td>
              <td width="155"><div align="center"><?php echo $row_Recordset1['tarikh_bayar']; ?></div></td>
              <td width="119"><div align="center"><a href="1.php?id=<?php echo $row_Recordset1['id']; ?>" type="button" style="color:#FFFFFF" class="btn btn-primary">Cetak</a></div></td>
            </tr>
