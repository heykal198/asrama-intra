<?php require_once('Connections/asrama.php'); ?><?php
if (!isset($_SESSION)) {
  session_start();
}
$MM_authorizedUsers = "";
...
<div id="tabs">
    ...
    <div id="tabs-1">
	<center>
      <p><a href="asrama.php" style="color:#FFFFFF" type="button" class="btn btn-success">Kembali</a> <a href="carian_bayaran_asrama.php" style="color:#FFFFFF" type="button" class="btn btn-success">Mengikut Asrama</a></p>
      <form name="form1" method="post" action="kemaskini_bayaran.php?ic=<?php echo $row_Recordset1['ic']; ?>">
        <label>
        <div align="center" class="btn-primary">
          <table width="328">
            <tr>
              <td>Masukan No Kad pengenalan : </td>
            </tr>
          </table>
          <input name="ic" type="text" id="ic" value="<?php echo $row_Recordset1['ic']; ?>" size="35" placeholder="No Ic">
          <br>
