...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Bayaran Asrama</a> </li>
    </ul>
	...
	<center>
      ...
      <form name="form1" method="post" action="">
        <p><a href="bayar_asrama.php" style="color:#FFFFFF" type="button" class="btn btn-primary">Kembali</a> <strong></strong></p>
        <table width="626">
          <tr>
            <td width="616"><strong><?php echo $row_Recordset1['nama']; ?></strong></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <table width="942" height="100" border="1">
          <tr>
            <th width="211" height="22"><div align="center">ASRAMA</div></th>
            <th width="141"><div align="center">BAYARAN</div></th>
            <th width="169"><div align="center">BAYARAN YANG DILAKSANAKAN</div></th>
            <th width="163"><div align="center">TARIKH</div></th>
            <th width="110"><div align="center">KEMASKINI</div></th>
            <th width="112"><div align="center">PRINT</div></th>
          </tr>

          <tr>
            <td height="24"><div align="center"><?php echo $row_Recordset1['penempatan']; ?></div></td>
            ...
            <td><div align="center"><a href="kemaskini_bayaran.php?id=<?php echo $row_Recordset1['id']; ?>"button" style="color:#FFFFFF" class="btn btn-danger">KEMASKINI</a></div></td>
            <td><div align="center"><a href="1.php?ic=<?php echo $row_Recordset1['ic']; ?>"button" style="color:#FFFFFF" class="btn btn-primary">Print</a></div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        </form>
