    ...
    <div id="header">
      <div id="logo">
        <div class="container layout_header">
          <img src="assets/img/pengurusan.png" alt="">    
        </div>
      </div>
...
<h6 id="h-menu-products" class="selected"><a href="index.php"><span>Halaman Utama</span></a></h6>
<ul id="menu-products" class="opened">
	<li><a href="daftar.php">Pendaftaran Asrama</a></li>
	<li><a href="carian_bayaran_asrama.php">Carian Asrama</a></li>
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Senarai Pelajar Di Asrama </a></li>
      </ul>
	  <p><br>
</p>
	  
	      <a href="carian_bayaran_asrama.php" type="button" class="btn btn-danger">Kembali</a>
        <p>&nbsp;	      </p>
	    <p>&nbsp;</p>
</div>
          </div>
