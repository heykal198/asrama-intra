...
<head>
    ...
    <title>Pengurusan Asrama | Carian Kemaskini</title>
...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Carian Kemaskini</h1>
<div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <center>
                            <form class="form-inline" role="form" method="post" action="kemaskini_data.php">
                          <div class="form-group">
                    
                          <label><input name="ic" type="text" class="form-control" id="exampleInputEmail2" placeholder="980706-23-5423"></label>
                          </div>
                          <button name="bcari" type="submit" value="Cari" class="btn btn-success">Cari</button>
