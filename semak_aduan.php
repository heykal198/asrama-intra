...
<div id="tabs">
    ...
    <div id="tabs-1">
	<center>
      <p><a href="asrama.php" style="color:#FFFFFF" type="button" class="btn btn-info">Kembali</a>
     <a href="semak_ikut_asrama.php" style="color:#FFFFFF" type="button" class="btn btn-info">Semak Mengikut Asrama</a></p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <table class="table table-bordered">
        <tr>
          <th width="5%" scope="col"><div align="center">NAMA</div></th>
          <th width="8%" scope="col"><div align="center">TARIKH ADUAN </div></th>
          <th width="12%" scope="col"><div align="center">ASRAMA</div></th>
          <th width="31%" scope="col"><div align="center">ADUAN </div></th>
          <th width="16%" scope="col"><div align="center">MAKLUM BALAS </div></th>
          <th width="28%" scope="col"><div align="center">TINDAKAN</div></th>
        </tr>
        <?php do { ?>
          <tr>
              <td height="59"><div align="center"><strong></strong><?php echo $row_Recordset1['nama']; ?></div></td>
            <td><div align="center"><?php echo $row_Recordset1['tarikh']; ?></div></td>
            <td><div align="left"><?php echo $row_Recordset1['penempatan']; ?></div></td>
            <td><div align="left"><?php echo $row_Recordset1['komen']; ?></div></td>
            <td><div align="center"><?php echo $row_Recordset1['tindakan']; ?></div></td>
            <td><div align="center"><a href="padam_aduan.php?ID=<?php echo $row_Recordset1['ID']; ?>"onclick="return confirm('Are you sure want to delete?');" type="button" style="color:#FFFFFF" class="btn btn-danger">PADAM</a> | <a href="feedback.php?ic=<?php echo $row_Recordset1['ic']; ?>" type="button" style="color:#FFFFFF" class="btn btn-primary">PENGESAHAN</a></div></td>
          </tr>
