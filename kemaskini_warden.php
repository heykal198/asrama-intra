...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE warden_lelaki SET nama=%s, no_tel=%s, ic=%s WHERE id=%s",
...
mysql_select_db($database_asrama, $asrama);
$query_Recordset1 = sprintf("SELECT * FROM warden_lelaki WHERE ic = '%s'", $colname_Recordset1);
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Kemaskini warden</a></li>
    </ul>

    <div id="tabs-1">
	<center>
      <p>&nbsp;</p>
      <p align="left"><a href="asrama.php" type="button" style="color:#FFFFFF" class="btn btn-success">Kembali</a>      </p>
      <div id="right2">
...
<form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
  <table class="table table-bordered">
    <tr>
      <th width="23%" colspan="2" scope="col">NAMA</th>
      <th width="22%" scope="col">NO. TEL </th>
      <th width="16%" scope="col">NO. KAD PENGENALAN </th>
      </tr>
    <tr>
      <td><input name="id" type="hidden" id="id" value="<?php echo $row_Recordset1['id']; ?>"></td>
      <td><div align="center">
        <input name="nama" type="text" id="nama" value="<?php echo $row_Recordset1['nama']; ?>" size="35" />
      </div></td>
      <td><div align="center">
        <input name="no_tel" type="text" id="no_tel" value="<?php echo $row_Recordset1['no_tel']; ?>" size="35" />
      </div></td>
      <td><div align="center">
        <input name="ic" type="text" id="ic" value="<?php echo $row_Recordset1['ic']; ?>" size="35" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
