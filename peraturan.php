...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Waktu Keluar Masuk Asrama </a></li>
    </ul>

    <div id="tabs-1">
          <div align="left"><a href="page_peraturan.php" style="color:#FFFFFF" type="button" class="btn btn-info">Kembali</a>
...
<h2>WAKTU KELUAR MASUK ASRAMA</h2>
<form name="form1" method="POST">
  <div align="center">
    <table width="659" height="122">
      <tr>
        <th width="245"><div align="center">HARI</div></th>
        <th width="402"><div align="center">WAKTU</div></th>
      </tr>
      <tr>
        <td><div align="center"><strong>ISNIN,SELASA,</strong><strong>RABU,KHAMIS</strong></div></td>
        <td><div align="center"><?php echo $row_Recordset1['isnin_selasa_rabu_khamis']; ?></div></td>
      </tr>
      <tr>
        <td><div align="center"><strong>JUMAAT</strong></div></td>
        <td><div align="center"><?php echo $row_Recordset1['jumaat']; ?></div></td>
      </tr>
      <tr>
        <td><div align="center"><strong>SABTU</strong></div></td>
        <td><div align="center"><?php echo $row_Recordset1['sabtu']; ?></div></td>
      </tr>
      <tr>
        <td><div align="center"><strong>AHAD</strong></div></td>
        <td><div align="center"><?php echo $row_Recordset1['ahad']; ?></div></td>
      </tr>
    </table>
  </div>
</form>
