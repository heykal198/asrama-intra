...
<div id="tabs">
	...
	<center>
	  ...
	  <a href="senarai_asrama.php" type="button" style="color:#FFFFFF" class="btn btn-primary">Senarai Asrama</a>
	<a href="semak_aduan.php" type="button" style="color:#FFFFFF" class="btn btn-primary">Semak Aduan</a>
	<a href="carian_bayaran_asrama.php" type="button" style="color:#FFFFFF" class="btn btn-primary">Bayaran Asrama</a>
	<a href="warden.php" type="button" style="color:#FFFFFF" class="btn btn-primary">Kemaskini Warden</a>
