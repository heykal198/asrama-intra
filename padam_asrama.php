...
mysql_select_db($database_asrama, $asrama);
$query_Recordset1 = sprintf("SELECT * FROM asrama WHERE penempatan = '%s'", $colname_Recordset1);
...
<div id="tabs">
    <ul>
	  ...
	  <p>      
	  <p><a href="asrama.php" type="button" class="btn btn-danger">Kembali</a>      
	    <a href="tambah_asrama.php" type="button" class="btn btn-danger">Tambah Asrama</a>
	  <p><br>
	    ...
	    <form name="form1" method="post" action="">
          <table class="table table-bordered">
            ...
            <tr>
              <td><label>
                <input name="penempatan" type="text" id="penempatan" value="<?php echo $row_Recordset1['penempatan']; ?>" size="80">
              </label></td>
            </tr>
          </table>
          <p>&nbsp;</p>
