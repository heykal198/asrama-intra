...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO warden_lelaki (nama, no_tel, ic) VALUES (%s, %s, %s)",
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Tambah Warden</a></li>
    </ul>
          ...
          <div id="tabs2">
            <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
              ...
              <table width="100%" border="0" class="art-article">
                ...
                <tr class="even">
                  <td><input name="nama" type="text" id="nama" size="58" oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required/></td>
                </tr>
                <tr class="even">
                  <td>No. Tel:</td>
                </tr>
                <tr class="even">
                  <td><input name="no_tel" type="text" id="no_tel" size="58" oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required/></td>
                </tr>
                <tr class="even">
                  <td>No Kad Pengenalan :</td>
                  </tr>
                <tr class="even">
                  <td><input name="ic" type="text" id="ic" size="58" oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required/>                  </td>
                  </tr>
                <tr class="even">
                  <td><label>
                  <input name="Daftar" type="submit" class="btn-success" id="Daftar" value="Daftar">
                  </label></td>
                </tr>
                <tr class="even">
                  <td>&nbsp;</td>
