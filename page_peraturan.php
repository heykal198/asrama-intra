    ...
    <div id="header-inner">
        ...
        <div class="corner tr"></div>
          ...
          <div align="right">
            <table width="200">
              <tr>
                <td><span class="progress-danger style4"></span></td>
              </tr>
</table>
          </div>
          <div align="right"></div>
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Peraturan Asrama</a></li>
    </ul>

    <div id="tabs-1">
	<center>
      <a href="aduan.php" style="color:#FFFFFF" type="button" class="btn btn-info">Kembali</a>
	<a href="peraturan.php" style="color:#FFFFFF" type="button" class="btn btn-info">Waktu Keluar/Masuk</a>
		  ...
		  <div id="div">
		    ...
		    <form name="form1" method="POST">
		      ...
		      <div align="left">
		        <ul>
		          <li> <strong>Sekiranya  ada pengghuni asrama yang melanggar peraturan yang telah ditetapkan,secara  automatic peraturan tersebut terbatal dan akan digantikan peraturan yang baru  dan lebih ketat</strong></li>
		          <li> <strong>Pemantauan  dibuat oleh warden asrama masing-masing dan segala laporan berkaitan dengan  penghuni asrama pihak warden perlu maklum terus kepada puan siti (pengetua)</strong></li>
		          <li> <strong>Penghuni  asrama dibenarkan menonton wayang tapi tidak dibenarkan menonton wayang yang  akan akan habis melebihi pukul 8:00 malam</strong></li>
		          <li> <strong>Sekiranya  ada warden yang bersubahat dengan penghuni asrama pihak pengurusan akan  mengambil tindakan terhadap warden tersebut.</strong></li>
		          </ul>
		        </div>
		    </form>
		    <p align="left">&nbsp;</p>
