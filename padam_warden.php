...
mysql_select_db($database_asrama, $asrama);
$query_Recordset1 = sprintf("SELECT * FROM warden_lelaki WHERE id = %s", $colname_Recordset1);
    ...
    <div align="left">
      <table width="88%" class="table table-bordered">
          <tr>
            ...
            <th width="32%" scope="col">NO. TEL </th>
            <th width="43%" scope="col">NO. KAD PENGENALAN </th>
            </tr>
          <tr>
            <td><div align="center">
              <input name="nama22" type="text" id="nama22" value="<?php echo $row_Recordset1['nama']; ?>" size="35" />
            </div></td>
            <td><div align="center">
              <input name="nama2" type="text" id="nama2" value="<?php echo $row_Recordset1['no_tel']; ?>" size="35" />
              </div></td>
            <td><div align="center">
              <input name="nama3" type="text" id="nama3" value="<?php echo $row_Recordset1['ic']; ?>" size="35" />
              </div></td>
            </tr>
        </table>
    </div>
