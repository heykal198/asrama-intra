...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE daftar SET penempatan=%s WHERE ic=%s",
...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Senarai Pelajar Di Asrama <?php echo $row_Recordset1['penempatan']; ?></a></li>
      </ul>
	  <p>&nbsp;</p>
	  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
          <p><a href="senarai_asrama.php" style="color:#FFFFFF" type="button" class="btn btn-info">Kembali</a></p>
          <p>&nbsp;</p>
          <table width="78%" class="table table-bordered">
            <tr>
              <th width="12%" scope="col">NAMA</th>
              <th width="5%" scope="col">NO TEL </th>
              <th width="17%" scope="col">KURSUS</th>
              <th width="16%" scope="col">ASRAMA</th>
              <th width="23%" scope="col">NAMA PENJAGA</th>
            ...
            <tr>
              ...
              <td><label><?php echo $row_Recordset1['tel']; ?></label></td>
              <td><?php echo $row_Recordset1['kursus']; ?></td>
              <td><div align="center">
                  <select style="border:none" style="width: 270px !important; min-width: 270px; max-width: 270px;" name="penempatan" id="penempatan" title="<?php echo $row_Recordset1['penempatan']; ?>" oninvalid="this.setCustomValidity('Sila Pilih Asrama')" required>
                    <option value="[Sila Pilih Jenis Penempatan]" selected <?php if (!(strcmp("[Sila Pilih Jenis Penempatan]", $row_Recordset1['penempatan']))) {echo "selected=\"selected\"";} ?>>[Sila Pilih Jenis Penempatan]</option>
              ...
              <td><?php echo $row_Recordset1['nama_penjaga']; ?></td>
              <td><?php echo $row_Recordset1['tel_penjaga']; ?>
                <input name="ic" type="hidden" id="ic" value="<?php echo $row_Recordset1['ic']; ?>"></td>
              <td><label>
