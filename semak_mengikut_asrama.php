...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Semak Aduan Mengikut Asrama </a></li>
      </ul>
    ...
    <div id="tabs-1">
	<center>
      <form action="semak_aduan_mengikut_asrama.php?penempatan=<?php echo $row_Recordset1['penempatan']; ?>" method="post" name="form1" class="box">
        <label>
