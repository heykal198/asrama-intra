...
<h6 id="h-menu-products" class="selected"><a href="index.php"><span>Log Masuk Admin ? </span></a></h6>
...
<div id="tabs">
    ...
    <div id="tabs-1">
      <p>&nbsp;</p>
      <form name="form1" method="post" action="papar_pass_admin.php">
        <table width="778">
          <tr>
            <td width="62" height="99">&nbsp;</td>
            <td width="704"><span class="style1">Sila Masukan Ruang Di Bawah</span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>Nama Pengguna : </td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required name="username" type="text" id="username" size="58">
            </label></td>
          </tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required name="1" type="text" id="1" size="58">
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input oninvalid="this.setCustomValidity('Sila Isi Ruang Ini')" required name="2" type="text" id="2" size="58">
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
