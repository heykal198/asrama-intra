...
<div id="tabs">
	...
	<center>
      ...
      <form name="form1" method="post" action="">
        ...
        <p>&nbsp;</p>
        <table width="712" height="100" border="1">
          <tr>
            <th width="104" height="22"><div align="center">NAMA</div></th>
            <th width="105" height="22"><div align="center">ASRAMA</div></th>
          ...
          <?php do { ?>
            <tr>
              <td height="24"><strong><?php echo $row_Recordset1['nama']; ?></strong></td>
