...
$(document).ready(function(){
	...
	required = ["nostaf","nama","notel","nopensyarah","fakulti","kod","nama_subjek","nama_kursus","katalaluan","nopelajar","kursus","hari","kod_kursus","bilik","subjek"];
	...
	$("#login,#form_pentadbir,#form_pensyarah,#form_fakulti,#form_subjek,#form_kursus,#form_pelajar,#form_jadual").submit(function(){	
