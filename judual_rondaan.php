...
$query_Recordset1 = sprintf("SELECT * FROM jadual_rondaan WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<head>
    ...
    <title>Pengurusan Asrama | Jadual Rondaan</title>
...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Jadual Rondaan</h1>
                    <div class="pull-right">
                <label>
                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#tambah_rondaan">
                                Tambah Jadual Rondaan
                            </button></label></div>
<table class="table table-bordered table-hover table-striped">
  <tr>
    <th scope="col">PENEMPPATAN</th>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Recordset1['tarikh']; ?></td>
      <td><?php echo $row_Recordset1['masa']; ?></td>
      <td><a href="" class="btn btn-success">Kemaskini</a></td>
      <td><a href="padam_jadual.php?id=<?php echo $row_Recordset1['id']; ?>" class="btn btn-danger">Padam</a></td>
...
<!-- jQuery -->
    ...
    <?php include 'tambah_rondaan.php';?>