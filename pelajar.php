...
$query_Recordset1 = sprintf("SELECT * FROM daftar WHERE ic = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<head>
    ...
    <title>Pengurusan Asrama | Carian Pelajar</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <br />
                        ...
                        <li>
                            <a class="active" href="#"><i class="fa fa-search fa-fw"></i> Carian<span class="fa arrow"></span></a>
...
<div class="row">
  <div class="col-lg-12">
                    <h1 class="page-header">Carian Pelajar</h1>
<table class="table table-striped table-bordered table-hover">
  <tr>
    ...
    <td>MAKLUMAT PENJAGA</td>
    <td>TELEFON PENJAGA</td>
    <td></td>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Recordset1['alamat_penjaga']; ?></td>
      <td><?php echo $row_Recordset1['maklumat_penjaga']; ?></td>
      <td><?php echo $row_Recordset1['tel_penjaga']; ?></td>
      <td><a href="padam_pelajar.php?id=<?php echo $row_Recordset1['id']; ?>" class="btn btn-danger">Padam</a></td>
    </tr>
