...
if ((isset($_GET['ID'])) && ($_GET['ID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM aduan WHERE ID=%s",
                       GetSQLValueString($_GET['ID'], "int"));

  mysql_select_db($database_asrama, $asrama);
  $Result1 = mysql_query($deleteSQL, $asrama) or die(mysql_error());

  $deleteGoTo = "semak_aduan.php";
...
<div id="tabs">
    ...
    <div id="tabs-1">
	<center>
      <p><a href="carian_asrama.php" type="button" class="btn btn-success">Pelajar Di Asrama</a>
      ...
      <form name="form1" method="post" action="">
        <table class="table table-bordered">
          <tr>
            <th width="4%" scope="col"><div align="center">NAMA</div></th>
            <th width="8%" scope="col"><div align="center">TARIKH ADUAN </div></th>
            <th width="22%" scope="col"><div align="center">ASRAMA</div></th>
            <th width="50%" scope="col"><div align="center">ADUAN</div></th>
          </tr>
          <tr>
            <td height="54"><div align="center">
              <input name="textfield5" type="text" value="<?php echo $row_Recordset1['nama']; ?>">
            </div></td>
            <td><div align="center">
              <input name="textfield3" type="text" value="<?php echo $row_Recordset1['tarikh']; ?>">
            </div></td>
            <td><div align="center">
              <input name="textfield2" type="text" value="<?php echo $row_Recordset1['alamat']; ?>">
            </div></td>
            <td><label>
              <div align="center">
                <input name="textfield" type="text" value="<?php echo $row_Recordset1['komen']; ?>">
                </div>
            </label></td>
          </tr>
        </table>
