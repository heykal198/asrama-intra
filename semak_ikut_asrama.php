...
<div id="tabs">
    ...
    <p>&nbsp;</p>
    <p><a href="semak_aduan.php" style="color:#FFFFFF" type="button" class="btn btn-success">Kembali</a></p>
    <div align="center">
      <table width="378">
        <tr>
    ...
    <div id="tabs-1">
	<center>
      <form action="semak_aduan_mengikut_asrama.php" method="post" name="form1" class="box">
        <label>
