...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Carian Pendaftaran ID </a></li>
      </ul>
    ...
    <div align="center">
      <table width="332">
          <tr>
            <td width="269">Masukan No Kad pengenalan : </td>
          </tr>
          </table>
    </div>
    <div id="tabs-1">
	<center>
      <form name="form1" method="post" action="daftar_pelatih.php">
        <label>
        <input name="ic" type="text" id="ic" size="40" placeholder="No Ic">
		<br>
        <input name="Pergi" type="submit" class="btn-info" id="Pergi" value="Pergi">
        </label>
        <label></label>
            </form>
		  </center>
