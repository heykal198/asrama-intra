...
<div id="tabs">
    <ul>
      <li><a href="#tabs-1">Carian Pelajar Mengikut IC </a></li>
      </ul>

    <p><a href="carian_pelajar.php" style="color:#FFFFFF" type="button" class="btn btn-danger">Kembali</a></p>
	<center>
      <form action="papar_mengikut_ic.php" method="post" name="form1" class="btn-primary">
        <table width="328">
          <tr>
            <td width="274">Masukan  No Kad Pengenalan : </td>
          </tr>
        </table>
        <label>
        <input name="ic" type="text" id="ic" size="35" placeholder="No I/C">
<br>
