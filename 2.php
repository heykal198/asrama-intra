...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bayar (nama, ic, penempatan, laksana, bayaran, tarikh_bayar) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nama'], "text"),
                       GetSQLValueString($_POST['ic'], "text"),
                       GetSQLValueString($_POST['penempatan'], "text"),
                       GetSQLValueString($_POST['laksana'], "text"),
...
mysql_select_db($database_asrama, $asrama);
$query_Recordset2 = "SELECT * FROM bayar";
      ...
      <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
        ...
        <div align="left">
          <table width="346">
              <tr>
                <td width="53">&nbsp;</td>
                <td width="281">Nama : </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="nama" type="text" class="field left" id="nama" value="<?php echo $row_Recordset1['nama']; ?>" size="45" readonly></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="ic" type="text" class="field left" id="ic" value="<?php echo $row_Recordset1['ic']; ?>" size="45" readonly></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Asrama : </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="penempatan" type="text" class="field left" id="penempatan" value="<?php echo $row_Recordset1['penempatan']; ?>" size="45" readonly></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Bayaran : </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="bayaran" type="text" id="bayaran" size="45"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Pelaksanaan : </td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="laksana" type="text" id="laksana" size="45"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Tarikh Pembayaran (Terbaru) : </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="tarikh_bayar" type="date" id="tarikh_bayar"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="Submit2" type="submit" class="btn-warning" value="KEMASKINI"> </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
