	...
	<center>
      ...
      <form name="form1" method="POST">
        <table width="62%" class="table table-bordered">
          <tr>
            <th width="10%" scope="col"><div align="center">HARI</div></th>
            <th colspan="2" scope="col"><div align="center">WAKTU KELUAR MASUK ASRAMA </div></th>
            </tr>
          <tr>
            <td><div align="center"></div></td>
            <td width="10%">&nbsp;</td>
            <?php echo $row_Recordset1['isnin_selasa_rabu_khamis']; ?>
                </table>
      </form>
      <p>&nbsp;</p>
      </center>
